...
public class BoardTest {
    /*
        ...
        Queen: (0,3), (7,3)
     */
    @DisplayName("Should return the board properly setup!")
    @Test
    public void shouldReturnAProperBoard(){
       BoardImpl board = new BoardImpl();
        ...
        for(int i = 0; i < 8; i++){
            Assertions.assertEquals("pieces.Piece", board.getPieceAt(new Position(1, i)).getClass().getName());
        }
    }
}
